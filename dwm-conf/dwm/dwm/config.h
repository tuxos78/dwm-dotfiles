...
static const char *poweroffcmd[]    = { "st", "-e", "doas", "poweroff", NULL };
static const char *rebootcmd[]      = { "st", "-e", "doas", "reboot", NULL };
static const char *updatecmd[]      = { "st", "-e", "doas", "xbps-install", "-Syu", NULL };
